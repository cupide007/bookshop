...
//                .withClaim("readerName", ReaderName)//该代码要改为实际项目中需要存放的对象
...
//     */
//    public static String getReaderNameByToken(String token) throws JWTDecodeException {
//        DecodedJWT decodedJWT = JWT.decode(token);
//        if (!JwtConstant.SUBJECT_SHOP.equals(decodedJWT.getSubject())) {
//            throw new RuntimeException("签名验证失败");
//        }
//        return decodedJWT.getClaim("readerName").asString();//获取customerId，与上面红色字体存放的内容对应。如果customerId参数类型是String，就把asInt()改为asString()
//    }
}
